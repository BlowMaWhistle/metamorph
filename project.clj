...
(defproject metamorph "0.3.1"
  ...
  :native-image {:name "metamorph"
                 :opts ["--verbose" "--no-fallback" "-H:ReflectionConfigurationFiles=META-INF/native-image/reflect-config.json"
                        "--initialize-at-build-time=com.fasterxml.jackson.core,com.fasterxml.jackson.dataformat,clojure.core.cache.wrapped__init,clojure.core.cache__init,clojure.core.reducers__init,clojure.core.rrb_vector.interop__init"]}
